...
return [
    ...
    'App' => [
        ...
        'defaultTimezone' => env('APP_DEFAULT_TIMEZONE','Asia/Karachi'),
        'base' => false,
        'dir' => 'src',
        'webroot' => 'webroot',
        'wwwRoot' => WWW_ROOT,
    ...
    'CakePdf' => [
        'engine' => 'CakePdf\MpdfEngine', // Use Mpdf as the engine
        'options' => [
            'defaultFont' => 'Arial', // Set default font
            'format' => 'A4', // Set default page format
            'orientation' => 'portrait', // Set default orientation
        ],
        'margin' => [
            'bottom' => 15,
            'left' => 50,
        ...
        'download' => true, // Set to true to force download
    ],
];
